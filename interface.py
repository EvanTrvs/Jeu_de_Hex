...
def fin_partie(team, search, partie1):
    chemin = []
    size = len(search)
...
def boutons_creations(frame, width):
    ...
    OA.add_command(label="Enregistrer sur A", font=("Arial", int(width*0.01)))
    OA.add_command(label="Charger A", font=("Arial", int(width*0.01)))
    OA.entryconfig('Charger A', state='disabled')

    OB = tk.Menu(B, tearoff=0)
    OB.add_command(label="Enregistrer sur B", font=("Arial", int(width*0.01)))
    OB.add_command(label="Charger B", font=("Arial", int(width*0.01)))
    OB.entryconfig('Charger B', state='disabled')

    OC = tk.Menu(C, tearoff=0)
    OC.add_command(label="Enregistrer sur C",font=("Arial", int(width*0.01)))
    OC.add_command(label="Charger C", font=("Arial", int(width*0.01)))
...
def affichage_accueil(fe, frame, width):
    ...
    parties = tk.Button(frame, text='Charger une Sauvegarde', font=("Arial", int(width*0.03), "bold"))
    ...
    return shortcut, play, Save1, Save2, Save3
...
def affichage_parametres(fe, frame, width):
    ...
    botB1 = tk.Radiobutton (option, text = 'Pathfinding', variable = choixb1, value = 2, font=("Arial", int(width*0.015)))
    ...
    botB2 = tk.Radiobutton (option, text = 'Pathfinding', variable = choixb2, value = 2, font=("Arial", int(width*0.015)))
